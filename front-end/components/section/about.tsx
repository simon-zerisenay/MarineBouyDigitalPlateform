...
const BuoyDescription = () => {
  return (
    <div className="bg-gray-100 p-8 rounded-lg shadow-md dark:bg-slate-950 dark:text-gray-100">
      <h2 className="text-3xl font-semibold mb-6 text-center">Continuous Monitoring System</h2>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 ">
        <div className="flex item-start bg-white rounded-lg p-6 shadow-md dark:bg-black dark:text-gray-100">
          <div>
            <p className="text-2xl font-medium mb-4 ">Unlock the Power of Real-Time Ocean Insights</p>
        ...
        <div className="flex item-start bg-white rounded-lg p-6 shadow-md dark:bg-black dark:text-gray-100">
          <div>
            <p className="text-2xl font-medium mb-4">Discover a Dynamic Database</p>
        ...
        <div className="flex item-start bg-white rounded-lg p-6 shadow-md dark:bg-black dark:text-gray-100">
          <div>
            <p className="text-2xl font-medium mb-4">Stay Ahead of Contaminants</p>
        ...
        <div className="flex item-start bg-white rounded-lg p-6 shadow-md dark:bg-black dark:text-gray-100">
          <div>
            <p className="text-2xl font-medium mb-4">Fuel Climate Studies with Precision Data</p>
