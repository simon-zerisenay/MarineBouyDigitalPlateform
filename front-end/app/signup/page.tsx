      ...
      onClick={handleGoogleLogin}
        ...
        <p className="text-sm md:text-lg">Sign Up with Google</p>
            ...
            <div className="flex flex-col items-start">
              ...
              <button type="submit" className="w-full text-white  focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-blue-600 hover:bg-blue-400 dark:focus:ring-primary-800">Create an account</button>
              {registerMessage && (
              <p className="text-green-500 mt-1 text-sm font-sans font-light">
                {registerMessage}
              </p>)}
              <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                Already have an account? <Link href="/login"><span className="font-medium text-blue-700 hover:underline ">Login here</span></Link>
              </p>
            </form>
          </div>
        </div>
