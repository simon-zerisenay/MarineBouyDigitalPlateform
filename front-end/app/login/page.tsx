      ...
      onClick={handleGoogleLogin}
        ...
        <p className="text-sm md:text-lg">Log In with Google</p>
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
              ...
              <button type="submit" className="w-full text-white  focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-blue-600 hover:bg-blue-400 dark:focus:ring-primary-800">Log In</button>
              <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                Don&apos;t  have an account? <Link href="/signup"><span className="font-medium text-blue-700 hover:underline ">Create account here</span></Link>
              </p>
            </form>
          </div>
        </div>
